  ...
  void initState() {
    ...
    setState(() {
      ...
      for(int i=0;i<ItemList.length;i++){
        allItemPrice+=int.parse(ItemList[i]['price'])*int.parse(ItemList[i]['quantity']);
                                            ...
                                            children:[ Column(
                                              children: [
                                                    ...
                                                    GestureDetector(
                                                        onTap: (){
                                                          ...
                                                          setState(() {
                                                            ...
                                                            allItemPrice=allItemPrice-int.parse(ItemList[index]['price'])-priceTotal;
                                                            if(qua.toString()=="0"){
                                                ...
                                                IconButton(onPressed: (){
                                                  setState(() {
                                                     allItemPrice-=qua*int.parse(ItemList[index]['price']);
                                                    ItemList.removeAt(index);
                              ...
                              child: Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child:   Text(ItemList.isEmpty?"0":allItemPrice.toString(),style: TextStyle(fontSize: 20),textAlign: TextAlign.center,),
                                  ),
                                  Container(
                                    decoration: BoxDecoration(
                                        color: Colors.black,
